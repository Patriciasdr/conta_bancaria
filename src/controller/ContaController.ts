...
export class ContaController implements ContaRepository {
    ...
    cadastrar(conta: Conta): void {
        ...
        console.log(`${colors.fg.green}A conta número ${conta.numero} foi criada com sucesso!${colors.reset}`);
    }
    ...
    deletar(numero: number): void {
        ...
        if (buscaConta != null) {
            ...
            console.log(`${colors.fg.green}A Conta número ${numero} foi apagada com sucesso!${colors.reset}`);
        } else {
            console.log(`${colors.fg.red}A Conta número ${numero} não foi encontrada!${colors.reset}`);
        }
    }
